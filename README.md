...
[![My Skills](https://skillicons.dev/icons?i=py,ts,js,react,nextjs,tailwind,fastapi,prisma,firebase,mongodb,redis,sqlite,docker,git,java,cpp&perline=8)](https://skillicons.dev)
